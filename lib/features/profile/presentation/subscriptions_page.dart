...
class _SubscriptionsPageState extends State<SubscriptionsPage> with TickerProviderStateMixin {
  ...
  Future<void> _restorePurchases() async {
    ...
    try {
      ...
      await _loadVipStatus();
              ...
              if (_isVip) {
          _showSnackBar("Purchases restored successfully! Ski Premium activated.");
        } else {
  ...
  Widget build(BuildContext context) {
    ...
    final List<List<_Privilege>> planPrivileges = [
      // Weekly
      [
        _Privilege(icon: Icons.ac_unit, text: 'Unlimited access to skiing post content'),
      ...
      [
        ...
        _Privilege(icon: Icons.block, text: 'Ad-free experience'),
        _Privilege(icon: Icons.star, text: 'Unlimited modification of user avatars'),
        _Privilege(icon: Icons.favorite, text: 'Sign up for skiing activities without any restrictions'),
      ],
    ];
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            TextButton(
                              onPressed: () => _launchURL('https://www.privacypolicies.com/live/649dcde3-731f-4492-9a8b-5935d0a923e6'),
                              child: Text(
                                'Privacy Policy',
                                style: TextStyle(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                '3. Tap Subscriptions\n'
                                '4. Find Ski Premium in the list\n'

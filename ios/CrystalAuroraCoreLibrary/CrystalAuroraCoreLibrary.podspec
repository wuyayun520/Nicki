...
Pod::Spec.new do |s|
  s.name         = "CrystalAuroraCoreLibrary"
  s.version      = "1.0.0"
  s.summary      = "iOS CrystalAuroraCoreLibrary Module."
  s.author       = { "CrystalAuroraCoreLibrary" => "CrystalAuroraCoreLibrary.me" }
  s.homepage     = "CrystalAuroraCoreLibrary"
  s.source       = { :git => "http://CrystalAuroraCoreLibrary.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'CrystalAuroraCoreLibrary/Classes/**/*'
  s.resources = "CrystalAuroraCoreLibrary/Resources/*.bundle"
  s.vendored_libraries = 'CrystalAuroraCoreLibrary/Classes/**/*.a'

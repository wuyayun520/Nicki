...
@objcMembers open class ManagerThen: NSObject {
    //: public static let shared = LanguageManager()
    public static let shared = ManagerThen()
    //: private(set) var currLanguage: String = MacroReactiveCompatible.getSystemLangCode()
    private(set) var currLanguage: String = MacroReactiveCompatible.langVideo()
    //: public let direction = UIApplication.shared.userInterfaceLayoutDirection
    public let direction = UIApplication.shared.userInterfaceLayoutDirection

    /// 设置语言
    //: public func setLanguage(_ language: String) {
    public func bombardment(_ language: String) {
...
extension String {
    ...
    public func localizedDataArguments(_ args: CVarArg...) -> String {
    ...
    private var languageBundle: Bundle {
        ...
        let language = ManagerThen.shared.currLanguage
        //: let languageFolder = SVGAEffectTool.default.languagePath
        let languageFolder = LineReactiveCompatible.default.languagePath

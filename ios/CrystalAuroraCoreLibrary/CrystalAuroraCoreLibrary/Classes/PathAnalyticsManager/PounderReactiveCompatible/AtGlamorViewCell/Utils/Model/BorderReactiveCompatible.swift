...
//: @objcMembers public class BorderReactiveCompatible: JSONModel {
@objcMembers public class BorderReactiveCompatible: JSONModel {
    //: public var beautySuite =  BeautyItemType.Face
    public var beautySuite = GloryHashableRepresentation.Face
...
//: @objc extension BorderReactiveCompatible {
@objc extension BorderReactiveCompatible {
    //: func initWith(suiteType: BeautyItemType)-> BorderReactiveCompatible {
    func dataDismiss(suiteType: GloryHashableRepresentation) -> BorderReactiveCompatible {
        //: let model = BorderReactiveCompatible.init()
        let model = BorderReactiveCompatible()

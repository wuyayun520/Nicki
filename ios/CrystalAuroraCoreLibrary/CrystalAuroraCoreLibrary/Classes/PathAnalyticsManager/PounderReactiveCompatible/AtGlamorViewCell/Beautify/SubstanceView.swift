...
fileprivate let noti_arrayMessage:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class SubstanceView: UICollectionViewCell {
    //: override init(frame: CGRect) {
    override init(frame: CGRect) {
        //: super.init(frame: frame)
        super.init(frame: frame)
        //: self.setupSubviews()
        self.modelFileSubviews()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_arrayMessage.reversed(), encoding: .utf8)!)
    }
...
extension SubstanceView {
    //: func setCellModel(model: ProductLooksModel) {
    func duringStroke(model: ProductLooksModel) {
        //: self.iconView.image = UIImage.BundleImageNamed(name: model.filterNormalImageName)
        self.iconView.image = UIImage.namedImageNameBundle(name: model.filterNormalImageName)
        ...
        if model.isSelected {
            ...
            self.nameLab.textColor = UIColor.subject()
            //: }else {
        } else {

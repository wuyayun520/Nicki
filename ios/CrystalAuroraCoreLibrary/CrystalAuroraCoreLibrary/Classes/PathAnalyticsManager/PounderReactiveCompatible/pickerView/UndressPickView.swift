...
fileprivate let main_videoPath:[UInt8] = [0x48,0x4d,0x48,0x53,0x7,0x42,0x4e,0x43,0x44,0x51,0x19,0x8,0xff,0x47,0x40,0x52,0xff,0x4d,0x4e,0x53,0xff,0x41,0x44,0x44,0x4d,0xff,0x48,0x4c,0x4f,0x4b,0x44,0x4c,0x44,0x4d,0x53,0x44,0x43]

fileprivate func viewFail(show num: UInt8) -> UInt8 {
...
/*: "Cancel" :*/
fileprivate let notiSucceedTitle:String = "lab insideCancel"

/*: "Sure" :*/
fileprivate let k_oldStr:[Character] = ["S","u","r","e"]
...
class UndressPickView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: main_videoPath.map{viewFail(show: $0)}, encoding: .utf8)!)
    }
    ...
    private func handlePlayer() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(appearEqual))
        ...
        cancelButton.setTitle((String(notiSucceedTitle.suffix(6))).localized, for: .normal)
        //: cancelButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        cancelButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        //: cancelButton.setTitleColor(UIColor.black, for: .normal)
        cancelButton.setTitleColor(UIColor.black, for: .normal)
        //: cancelButton.addTarget(self, action: #selector(cancelClick(button:)), for: .touchUpInside)
        cancelButton.addTarget(self, action: #selector(modelButton(button:)), for: .touchUpInside)
        ...
        confirmButton.setTitle((String(k_oldStr)).localized, for: .normal)
        //: confirmButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        confirmButton.titleLabel?.font = UIFont.systemFont(ofSize: 16)
        //: confirmButton.setTitleColor(UIColor.black, for: .normal)
        confirmButton.setTitleColor(UIColor.black, for: .normal)
        //: confirmButton.addTarget(self, action: #selector(confirmClick(button:)), for: .touchUpInside)
        confirmButton.addTarget(self, action: #selector(corroborate(button:)), for: .touchUpInside)
    ...
    @objc func modelButton(button _: UIButton) {
        //: dismissView()
        appearEqual()
    }

    //: @objc func confirmClick(button: UIButton) {
    @objc func corroborate(button _: UIButton) {
        //: dismissView()
        appearEqual()
    }

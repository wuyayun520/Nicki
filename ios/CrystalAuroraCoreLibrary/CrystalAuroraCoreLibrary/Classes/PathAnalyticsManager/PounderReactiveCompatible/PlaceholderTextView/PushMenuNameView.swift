...
/*: / :*/
fileprivate let app_toName:String = "finish"

/*: "\n" :*/
fileprivate let mIndexKey:[Character] = ["\n"]
...
class PushMenuNameView: UIView {
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        viewSizeTitle(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        viewSizeTitle(placeholder: nil, placeholderColor: nil)
    }
}
...
extension PushMenuNameView {
    /// placeholder Label Setup
    //: private func setup(placeholder: String?, placeholderColor: UIColor?) {
    private func viewSizeTitle(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(DirectLabelOrigin().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(DirectLabelOrigin().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-DirectLabelOrigin().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: DropContainerInset().top, left: DropContainerInset().left, bottom: DropContainerInset().bottom, right: DropContainerInset().right)
...
extension PushMenuNameView: UITextViewDelegate {

...
fileprivate let mLayerFormat:[UInt8] = [0x8b,0x90,0x8b,0x96,0x4a,0x85,0x91,0x86,0x87,0x94,0x5c,0x4b,0x42,0x8a,0x83,0x95,0x42,0x90,0x91,0x96,0x42,0x84,0x87,0x87,0x90,0x42,0x8b,0x8f,0x92,0x8e,0x87,0x8f,0x87,0x90,0x96,0x87,0x86]

fileprivate func totalAfter(stop num: UInt8) -> UInt8 {
...
typealias SlidingHandler = (_ direction: AudileSlideDirection) -> Void
...
class SliderView: UIView {
    ...
    var cropStart: CGFloat {
        ...
        let offset = overlay.startOffset - (kIntervalervalText - self.contentView.contentOffset.x)
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mLayerFormat.map{totalAfter(stop: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIScrollView = {
        ...
        while time <= self.duration {
            ...
            let image = self.grandfather(point: time)
            //: imv.image = image
            imv.image = image
    ...
    lazy var overlay: CopernicanSystemThen = {
        ...
        let overlay = CopernicanSystemThen(frame: self.bounds, maxCropLen: maxWidth, minCropLen: minWidth)
...
extension SliderView {
    ...
    private func grandfather(point: CGFloat) -> UIImage {
...
extension SliderView: UIScrollViewDelegate {
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        let minx = kIntervalervalText - overlay.startOffset
    ...
    func scrollViewWillBeginDragging(_: UIScrollView) {
        ...
        self.overlay.currentReport(isShow: false)
    }
    ...
    func scrollViewDidEndDragging(_ scrollView: UIScrollView, willDecelerate decelerate: Bool) {
        ...
        self.overlay.currentReport(isShow: true)
    }
...
extension SliderView {
    ...
    private func subviewsPost() {
        ...
        self.contentView.snp.makeConstraints { make in
            ...
            make.leading.equalToSuperview().offset(kIntervalervalText)

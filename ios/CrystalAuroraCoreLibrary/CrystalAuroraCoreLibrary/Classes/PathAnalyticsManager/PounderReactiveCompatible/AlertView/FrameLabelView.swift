...
fileprivate let kViewMsg:[Character] = ["b","t","n","_","m","e","_","b","a","c","k","_","c","o","n","t","i","n"]
fileprivate let user_videoMsg:String = "uimage"

/*: "init(coder:) has not been implemented" :*/
fileprivate let notiSizePath:[UInt8] = [0x11,0x16,0x11,0x1c,0xd0,0xb,0x17,0xc,0xd,0x1a,0xe2,0xd1,0xc8,0x10,0x9,0x1b,0xc8,0x16,0x17,0x1c,0xc8,0xa,0xd,0xd,0x16,0xc8,0x11,0x15,0x18,0x14,0xd,0x15,0xd,0x16,0x1c,0xd,0xc]

fileprivate func extensionOn(service num: UInt8) -> UInt8 {
...
class FrameLabelView: UIView {
    ...
    private lazy var leftBtn: UIButton = {
        ...
        leftBtn.addTarget(self, action: #selector(makeClick), for: .touchUpInside)
        //: return leftBtn
        return leftBtn
        //: }()
    }()
    ...
    private lazy var rightBtn: UIButton = {
        ...
        rightBtn.addTarget(self, action: #selector(rightReportRound), for: .touchUpInside)
        //: return rightBtn
        return rightBtn
        //: }()
    }()
         ...
         config: SpaceAlertConfig)
    {
        ...
        if leftBtnTitle == nil && leftBtnAttributedTitle == nil {
            ...
            alertConfig.rightBackgroundImage = (String(kViewMsg) + user_videoMsg.replacingOccurrences(of: "image", with: "e"))
        }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: notiSizePath.map{extensionOn(service: $0)}, encoding: .utf8)!)
    }

    //: func changeRightBtn(title: String, isTouch: Bool) {
    func reApp(title: String, isTouch: Bool) {

...
class NumberView: UILabel {
    ...
    private func recordSetup() {
        ...
        layer.backgroundColor = UIColor.tableTag().cgColor
        //: textColor = .white
        textColor = .white
        //: font = UIFont.pingfangFont(type: .Medium, fontSize: 11)
        font = UIFont.fontFile(type: .Medium, fontSize: 11)
...
class LabelModelReactiveCompatible: UILabel {
    ...
    func mastheadRemove(isTop:Bool) {
        //: if isTop {
        if isTop {

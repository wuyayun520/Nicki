...
extension Dictionary {
    ...
    public static func picImage(withJsonString jsonString: String?) -> [String: Any]? {
...
extension NSDictionary {
    ...
    @objc public class func styleObject(withJsonString jsonString: String?) -> NSDictionary? {
        //: guard let result = Dictionary<String, Any>.dictionary(withJsonString: jsonString) else {
        guard let result = Dictionary<String, Any>.picImage(withJsonString: jsonString) else {
            //: return nil
            return nil
        }

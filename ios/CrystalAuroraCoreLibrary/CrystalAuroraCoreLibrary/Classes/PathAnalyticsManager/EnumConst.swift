...
enum TotalKeyRepresentable: Int {
    //: case Social  = 0
    case Social = 0 // 交友
    //: case Moment  = 1
    case Moment = 1 // 动态
...
enum VideoClusterLiteral: String {
    //: case AppleLogin
...
enum RequestSourceTableConvertible: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
enum NorSpaceNameConvertible: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
enum PtolemaicSystemScalar: Int {
    //: case isOnGoing = 0
...
enum ProductDefaultsSerializable: Int {
    //: case unknown    = 0
    case unknown = 0
    //: case social     = 1
    case social = 1 // 社交礼物
...
@objc public enum ViewUserSignedCount: Int {
    //: case Unavailable = 0
...
enum ConstraintCaseIterable: CaseIterable {
...
enum RenameEraseWidthTotal: Int {
    //: case nor = 1
    case nor = 1
    //: case match = 2
    case match = 2

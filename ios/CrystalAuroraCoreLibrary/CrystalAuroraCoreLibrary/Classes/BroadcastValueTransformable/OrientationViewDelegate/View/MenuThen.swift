...
fileprivate let appFrameIdent:[UInt8] = [0x4,0x9,0x4,0xf,0xc3,0xfe,0xa,0xff,0x0,0xd,0xd5,0xc4,0xbb,0x3,0xfc,0xe,0xbb,0x9,0xa,0xf,0xbb,0xfd,0x0,0x0,0x9,0xbb,0x4,0x8,0xb,0x7,0x0,0x8,0x0,0x9,0xf,0x0,0xff]

fileprivate func mediumAwake(wrap num: UInt8) -> UInt8 {
...
/*: "JXBannerCellID" :*/
fileprivate let mainListKey:String = "length text destroyJXBann"
fileprivate let mLeadingMsg:String = "brush makeerCellID"
...
class MenuThen: UITableViewCell {
    ...
    private var adBannderListData = [DigitizerMeasurable]()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: appFrameIdent.map{mediumAwake(wrap: $0)}, encoding: .utf8)!)
    }
...
extension MenuThen: JXBannerDataSource, JXBannerDelegate {
    //: func jxBanner(_ banner: JXBannerType) -> (JXBannerCellRegister) {
    func jxBanner(_: JXBannerType) -> (JXBannerCellRegister) {
        //: return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: "JXBannerCellID")
        return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: (String(mainListKey.suffix(6)) + String(mLeadingMsg.suffix(8))))
    }
...
extension MenuThen {
    ...
    func upToDateness(bannerData: [DigitizerMeasurable]) {

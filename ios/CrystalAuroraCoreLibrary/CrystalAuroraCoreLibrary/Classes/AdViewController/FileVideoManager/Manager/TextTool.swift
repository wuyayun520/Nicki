...
extension TextTool {
    ...
    func managerFace(_ frontCamera: Bool) {
        ...
        self.startFront(front: frontCamera)
    }
    
    /// 摄像头开启与关闭
    /// - Parameter openCamera: 是否开启
    //: func useCamera(_ openCamera: Bool) {
    func widen(_ openCamera: Bool) {
        ...
        self.shipFile(isOpen: openCamera)
    }
    ...
    func cropAdd() {
        ...
        DispatchQueue.main.async {
            ...
            self.every(smallWindow: self.infoModel?.renderPostion != .selfOnBg)
...
extension TextTool {
    ...
    private func startFront(front: Bool) {
    ...
    private func shipFile(isOpen: Bool) {
        //: guard SenseTime_Use == true else {
        guard k_bottomText == true else {
            //: if isOpen {
            if isOpen {
...
extension TextTool {
    ...
    func notificationWrite() {
        // 监听 App 切后台
        //: NotificationCenter.default.addObserver(self,
        NotificationCenter.default.addObserver(self,
                                               //: selector: #selector(appDidEnterBackground(notif:)),
                                               selector: #selector(buildSize(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(sweepUp(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(dismissDoing(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(executeStart(notif:)),
    ...
    @objc private func buildSize(notif: Notification?) {
        //: if notif == nil {
        if notif == nil {
            // 静音
    ...
    @objc private func sweepUp(notif: Notification?) {
        //: if notif == nil { 
    ...
    @objc private func dismissDoing(notif: Notification) {
    ...
    @objc func executeStart(notif: Notification) {

...
fileprivate let app_modelDataMsg:[UInt8] = [0xb7,0xb0,0xb7,0xaa,0xf6,0xbd,0xb1,0xba,0xbb,0xac,0xe4,0xf7,0xfe,0xb6,0xbf,0xad,0xfe,0xb0,0xb1,0xaa,0xfe,0xbc,0xbb,0xbb,0xb0,0xfe,0xb7,0xb3,0xae,0xb2,0xbb,0xb3,0xbb,0xb0,0xaa,0xbb,0xba]

/*: "icon_lounge" :*/
fileprivate let k_errMessage:String = "file identityicon_l"
fileprivate let show_momentSucceedName:[Character] = ["o","u","n","g","e"]

/*: "#777777" :*/
fileprivate let m_colorStr:[Character] = ["#","7","7","7","7","7","7"]

/*: "UID: :*/
fileprivate let showConversationName:[Character] = ["U","I","D",":"]
...
class ConstituentListView: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_modelDataMsg.map{$0^222}, encoding: .utf8)!)
    }
    ...
    private lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.namedImageNameBundle(name: (String(k_errMessage.suffix(6)) + String(show_momentSucceedName)))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(m_colorStr)))
        //: return lab
        return lab
        //: }()
    }()
...
extension ConstituentListView {
    /// 刷新
    //: func refreshCell(model: TalkingRecommendUserModel) {
    func upName(model: ViewRecommendHandyJSON) {
        //: headPicImgV.setUrlImage(urlStr: model.headPic)
        headPicImgV.placeOf(urlStr: model.headPic)
        //: nicknameLab.textColor = model.loungePlus ? .userVipColor():.appTitleColor()
        nicknameLab.textColor = model.loungePlus ? .career() : .startMake()
        //: nicknameLab.text = model.nickname
        nicknameLab.text = model.nickname
        //: uidLab.text = "UID:\(model.uid)"
        uidLab.text = (String(showConversationName)) + "\(model.uid)"
...
extension ConstituentListView {
    ...
    private func nonachievementBottom() {

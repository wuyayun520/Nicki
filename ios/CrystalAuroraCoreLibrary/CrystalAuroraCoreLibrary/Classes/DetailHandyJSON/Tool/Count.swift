...
/*: "detection" :*/
fileprivate let user_endStr:[Character] = ["d","e","t","e","c","t"]
fileprivate let user_sizeData:String = "iofailure"

/*: "aiff" :*/
fileprivate let dream_narrowId:String = "aifile"
...
class Count: NSObject {
    ...
    func statusBy() {
        ...
        let soundFilePath = LineReactiveCompatible.default.toCancel(name: (String(user_endStr) + user_sizeData.replacingOccurrences(of: "failure", with: "n")), type: (dream_narrowId.replacingOccurrences(of: "file", with: "ff")))
    ...
    @objc private func exceptIncrementTimer() {
        //: soundDuration += 0.001
        soundDuration += 0.001
    }

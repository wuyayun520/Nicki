...
/*: "id" :*/
fileprivate let kModelMessage:String = "imenu"
...
struct SpaceInfoModel: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: ArcanumAdMeasurable?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [ToTransformable]? // 相册
    ...
    var aiExtraInfo = DatabaseModelType() // AI模型
    //: var vipSkinId = 0
...
struct ArcanumAdMeasurable: HandyJSON {
    //: var count: Int = 0
    var count: Int = 0
    //: var list: Array<TalkingUserInfoMomentItemModel>?
    var list: [SourceAtItemModel]?
}

// MARK: - 动态Item

//: struct TalkingUserInfoMomentItemModel: HandyJSON {
struct SourceAtItemModel: HandyJSON {
...
struct ToTransformable: HandyJSON {
    ...
    func price(compareTo: ToTransformable) -> Bool {
        //: return
        return
...
struct DatabaseModelType: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重

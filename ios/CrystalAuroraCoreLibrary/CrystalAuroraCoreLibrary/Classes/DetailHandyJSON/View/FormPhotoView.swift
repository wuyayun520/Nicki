...
fileprivate let userDataMsg:[UInt8] = [0x21,0x26,0x21,0x3c,0x60,0x2b,0x27,0x2c,0x2d,0x3a,0x72,0x61,0x68,0x20,0x29,0x3b,0x68,0x26,0x27,0x3c,0x68,0x2a,0x2d,0x2d,0x26,0x68,0x21,0x25,0x38,0x24,0x2d,0x25,0x2d,0x26,0x3c,0x2d,0x2c]

/*: "img_faceverification_photopose" :*/
fileprivate let k_keyImageUrl:[Character] = ["i","m","g","_","f","a","c","e","v","e","r","i","f","i","c","a","t","i","o","n","_","p","h","o","t"]
fileprivate let notiTopMiniUrl:String = "opointimatee"

/*: "To pass the verification, in the photo you should:" :*/
fileprivate let mNameId:[UInt8] = [0xa,0x31,0x7e,0x2e,0x3f,0x2d,0x2d,0x7e,0x2a,0x36,0x3b,0x7e,0x28,0x3b,0x2c,0x37,0x38,0x37,0x3d,0x3f,0x2a,0x37,0x31,0x30,0x72,0x7e,0x37,0x30,0x7e,0x2a,0x36,0x3b,0x7e,0x2e,0x36,0x31,0x2a,0x31,0x7e,0x27,0x31,0x2b,0x7e,0x2d,0x36,0x31,0x2b,0x32,0x3a,0x64]

private func tagIndex(plain num: UInt8) -> UInt8 {
    return num ^ 94
}

/*: "· show your face clearly;" :*/
fileprivate let userColorValue:String = "all else· show"
fileprivate let noti_regularName:String = "managerace"
fileprivate let mainToName:String = "ly;user dominant new self count"

/*: "· pose exactly like the posing guide." :*/
fileprivate let appStyleValueViewFormat:[UInt8] = [0x30,0x45,0xd2,0x82,0x9d,0x81,0x97,0xd2,0x97,0x8a,0x93,0x91,0x86,0x9e,0x8b,0xd2,0x9e,0x9b,0x99,0x97,0xd2,0x86,0x9a,0x97,0xd2,0x82,0x9d,0x81,0x9b,0x9c,0x95,0xd2,0x95,0x87,0x9b,0x96,0x97,0xdc]

/*: "Your photo will never be uploaded to your profile or shown to anvone else." :*/
fileprivate let showFromViewId:[UInt8] = [0x2e,0x65,0x73,0x6c,0x65,0x20,0x65,0x6e,0x6f,0x76,0x6e,0x61,0x20,0x6f,0x74,0x20,0x6e,0x77,0x6f,0x68,0x73,0x20,0x72,0x6f,0x20,0x65,0x6c,0x69,0x66,0x6f,0x72,0x70,0x20,0x72,0x75,0x6f,0x79,0x20,0x6f,0x74,0x20,0x64,0x65,0x64,0x61,0x6f,0x6c,0x70,0x75,0x20,0x65,0x62,0x20,0x72,0x65,0x76,0x65,0x6e,0x20,0x6c,0x6c,0x69,0x77,0x20,0x6f,0x74,0x6f,0x68,0x70,0x20,0x72,0x75,0x6f,0x59]

/*: "Submit Photo" :*/
fileprivate let kGiftFormat:String = "mini"
fileprivate let dreamBackgroundMsg:[Character] = ["u","b","m","i","t"," ","P","h","o","t","o"]

/*: "btn_me_back_continue" :*/
fileprivate let m_centerData:[Character] = ["b","t","n","_","m","e","_","b","a","c","k"]
fileprivate let noti_userFilterName:String = "break let self_c"
fileprivate let m_sharedSizeEqualFormat:[Character] = ["o","n","t","i","n","u","e"]

/*: "Retake Photo" :*/
fileprivate let app_tapInviteTitle:[Character] = ["R","e","t","a","k","e"," ","P","h","o","t","o"]
...
class FormPhotoView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: userDataMsg.map{$0^72}, encoding: .utf8)!)
    }
    ...
    lazy var leftExampleImageView: UIImageView = {
        ...
        imgView.image = UIImage.namedImageNameBundle(name: (String(k_keyImageUrl) + notiTopMiniUrl.replacingOccurrences(of: "intimate", with: "s")))
    ...
    lazy var rightPhotoImageView: UIImageView = {
        ...
        imgView.backgroundColor = UIColor.eraseColor()
        //: imgView.layer.cornerRadius = 8
        imgView.layer.cornerRadius = 8
        //: imgView.layer.masksToBounds = true
        imgView.layer.masksToBounds = true
    ...
    lazy var titleLab: UILabel = {
        ...
        lb.text = String(bytes: mNameId.map{tagIndex(plain: $0)}, encoding: .utf8)!.localized
    ...
    lazy var firstDesLab: UILabel = {
        ...
        lb.text = (String(userColorValue.suffix(6)) + " your " + noti_regularName.replacingOccurrences(of: "manager", with: "f") + " clear" + String(mainToName.prefix(3))).localized
    ...
    lazy var secondDesLab: UILabel = {
        ...
        lb.text = String(bytes: appStyleValueViewFormat.map{$0^242}, encoding: .utf8)!.localized
        //: lb.textColor = .appValueDetailColor()
        lb.textColor = .totalervertebralDisc()
        //: lb.font = .pingfangFont(type: .Regular, fontSize: 16)
        lb.font = .fontFile(type: .Regular, fontSize: 16)
    ...
    lazy var bottomTipLab: UILabel = {
        ...
        lb.text = String(bytes: showFromViewId.reversed(), encoding: .utf8)!.localized
        //: lb.textColor = .appValueDetailColor()
        lb.textColor = .totalervertebralDisc()
    ...
    lazy var submitBtn: UIButton = {
        ...
        btn.setTitle((kGiftFormat.replacingOccurrences(of: "mini", with: "S") + String(dreamBackgroundMsg)).localized, for: .normal)
        //: btn.setBackgroundImage(UIImage.BundleImageNamed(name: "btn_me_back_continue"), for: .normal)
        btn.setBackgroundImage(UIImage.namedImageNameBundle(name: (String(m_centerData) + String(noti_userFilterName.suffix(2)) + String(m_sharedSizeEqualFormat))), for: .normal)
    ...
    lazy var retakeBtn: UIButton = {
        ...
        btn.setTitle((String(app_tapInviteTitle)).localized, for: .normal)
        //: btn.setTitleColor(.appValueColor(), for: .normal)
        btn.setTitleColor(.eraseColor(), for: .normal)
        //: btn.titleLabel?.font = .pingfangFont(type: .Regular, fontSize: 18)
        btn.titleLabel?.font = .fontFile(type: .Regular, fontSize: 18)
        //: return btn
        return btn
        //: }()
    }()
...
extension FormPhotoView {
    ...
    func enlargement() {
        ...
        let itemWidth = (kBlockRateValue - actualWidth(w: 40)) / 2.0
        ...
        bottomTipLab.snp.makeConstraints { make in
            ...
            make.bottom.equalTo(-24 - k_videoName)
        }

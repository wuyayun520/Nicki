...
fileprivate let mainViewIdent:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Add" :*/
fileprivate let dreamLayerRegularIdent:[Character] = ["A","d","d"]

/*: "btn_me_edit" :*/
fileprivate let mainContentText:String = "model stop printbtn_m"

/*: "Program" :*/
fileprivate let mainTipPopData:String = "inside managerProgr"
fileprivate let app_selectedIdent:[Character] = ["a","m"]
...
class ValueHeaderCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        self.backgroundColor = .subTarget()
        //: selectionStyle = .none
        selectionStyle = .none
        //: setupSubviews()
        saloonSubviews()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mainViewIdent.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var tipsLab: UILabel = {
        ...
        lb.text = (String(dreamLayerRegularIdent)).localized
        //: return lb
        return lb
        //: }()
    }()
    ...
    private lazy var editImg: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.namedImageNameBundle(name: (String(mainContentText.suffix(5)) + "e_edit")))
        //: imag.isUserInteractionEnabled = false
        imag.isUserInteractionEnabled = false
        //: return imag
        return imag
...
extension ValueHeaderCell {
    //: func setViewData(title: String, icon: String) {
    func build(title: String, icon: String) {
        //: iconImg.image = UIImage.BundleImageNamed(name: icon)
        iconImg.image = UIImage.namedImageNameBundle(name: icon)
        //: titleLab.text = title.localized
        titleLab.text = title.localized
        //: if title == "Program" {
        if title == (String(mainTipPopData.suffix(5)) + String(app_selectedIdent)) {
    ...
    func gesturePath(isHidden: Bool) {
    ...
    func installArrow() {
        ...
        backBtn.attributeAt(width: kBlockRateValue - 30, height: 50, corners: [.topLeft, .topRight], cornerRadii: .init(width: 8, height: 8))
    }
}

...
fileprivate let mSizeMessage:[UInt8] = [0x7d,0x7a,0x7d,0x60,0x3c,0x77,0x7b,0x70,0x71,0x66,0x2e,0x3d,0x34,0x7c,0x75,0x67,0x34,0x7a,0x7b,0x60,0x34,0x76,0x71,0x71,0x7a,0x34,0x7d,0x79,0x64,0x78,0x71,0x79,0x71,0x7a,0x60,0x71,0x70]

/*: "Full" :*/
fileprivate let appReFormat:[Character] = ["F","u","l","l"]

/*: "%@ Online" :*/
fileprivate let dream_playerFormat:[Character] = ["%","@"," ","O","n","l","i"]
fileprivate let m_appMsg:[Character] = ["n","e"]
...
class SizeViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mSizeMessage.map{$0^20}, encoding: .utf8)!)
    }
...
extension SizeViewCell {
    ...
    func positionCreate(model: AtAdListModel) {
        //: IconBtn.setUrlImage(urlStr: model.icon)
        IconBtn.frank(urlStr: model.icon)
        ...
        if model.isFull {
            ...
            numberLB.text = (String(appReFormat)).localized
            //: numberLB.textColor = UIColor.msgTipsColor()
            numberLB.textColor = UIColor.tableTag()
            //: }else {
        } else {
            //: numberLB.text = "%@ Online".localizedArguments(model.num)
            numberLB.text = (String(dream_playerFormat) + String(m_appMsg)).localizedDataArguments(model.num)
            //: numberLB.textColor = .appValueDetailColor()
            numberLB.textColor = .totalervertebralDisc()
        }
    }
}

...
/*: "App" :*/
fileprivate let mGiftIdent:[Character] = ["A","p","p"]

/*: "blockList_ :*/
fileprivate let app_finishEmptyId:String = "binfo"
fileprivate let dream_errorMsg:[Character] = ["o","c","k","L","i","s","t","_"]
...
// __CLOSE_PRINT__
//
//  ValueWorkReactiveCompatible.swift
//  AbroadTalking
//
...
class ValueWorkReactiveCompatible: NSObject {
    //: var blockList: [String]?
    var blockList: [String]? // 拉黑列表

    // singleton
    //: static let shared = TalkingBlockListManager()
    static let shared = ValueWorkReactiveCompatible()
    ...
    func barrelhouse(userId: String) {
    ...
    func inToPersonGift(userId: String) -> Bool {
    ...
    private func videoPrice() -> String {
        //: let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        //: let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent("App")
        let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent((String(mGiftIdent)))
        ...
        let filePath = (appDirectoryPath as NSString).appendingPathComponent((app_finishEmptyId.replacingOccurrences(of: "info", with: "l") + String(dream_errorMsg)) + "\(uid)")
        //: return filePath
        return filePath
    }
}

...
fileprivate let notiQuantityimateValue:[UInt8] = [0x30,0x35,0x30,0x3b,0xef,0x2a,0x36,0x2b,0x2c,0x39,0x1,0xf0,0xe7,0x2f,0x28,0x3a,0xe7,0x35,0x36,0x3b,0xe7,0x29,0x2c,0x2c,0x35,0xe7,0x30,0x34,0x37,0x33,0x2c,0x34,0x2c,0x35,0x3b,0x2c,0x2b]

fileprivate func wayOfLife(render num: UInt8) -> UInt8 {
...
class RemoveMenuCell: UITableViewCell {
    //: lazy var menuImageView: UIImageView = self.makeMenuImageView()
    lazy var menuImageView: UIImageView = self.tagImage()
    //: lazy var menuTitleLabel: UILabel = self.makeMenuTitleLable()
    lazy var menuTitleLabel: UILabel = self.colorPlaceCount()
    ...
    var dropMenuStyle: ProductMenuStyle? {
        //: didSet {
        didSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: notiQuantityimateValue.map{wayOfLife(render: $0)}, encoding: .utf8)!)
    }
    ...
    private func tagImage() -> UIImageView {
    ...
    private func colorPlaceCount() -> UILabel {
    ...
    private func isPlay() {
        ...
        lineLayer.strokeColor = UIColor.my(230, 230, 230, 1.0).cgColor

...
/*: "#E6BD8B" :*/
fileprivate let mToColorPath:String = "data make else invite#E6BD8B"

/*: "+ :*/
fileprivate let kViewMsg:String = "count"

/*: "get json error" :*/
fileprivate let k_timeId:String = "get jscount kit hidden"
fileprivate let showModelIdent:String = "on data false key"
fileprivate let dream_dataUrl:String = "emanageror"
...
class InfluenceThen: UIView {
    ...
    private lazy var pointLab: UILabel = {
        ...
        lab.font = UIFont.fontFile(type: .Semibold, fontSize: 24)
        //: lab.textColor = UIColor.init(hex: "#E6BD8B")
        lab.textColor = UIColor(hex: (String(mToColorPath.suffix(7))))
...
extension InfluenceThen {
    //: func setPointData(point: String, isminiStr: Bool = false) {
    func closeTitle(point: String, isminiStr: Bool = false) {
        ...
        let attributes = [.foregroundColor: UIColor(hex: (String(mToColorPath.suffix(7))))!, .font: UIFont.fontFile(type: .Semibold, fontSize: isminiStr ? 15 : 24)] as [NSAttributedString.Key: Any]
        ...
        let attributes2 = [.foregroundColor: UIColor(hex: (String(mToColorPath.suffix(7))))!, .font: UIFont.fontFile(type: .Semibold, fontSize: 14)] as [NSAttributedString.Key: Any]
        ...
        do {
            ...
            var url = LineReactiveCompatible.default.failure(type: .VideoCall_femalePoint)
            ...
            if NorAddrTool.share.interfaceLang == LipogramLangType.ar.rawValue {
                ...
                url = LineReactiveCompatible.default.failure(type: .videoCall_femalePoint_ar)
                ...
                url = LineReactiveCompatible.default.failure(type: .videoCall_femalePoint_es)
                ...
                url = LineReactiveCompatible.default.failure(type: .videoCall_femalePoint_pt)
            }
            ...
            printLog(message: (String(k_timeId.prefix(6)) + String(showModelIdent.prefix(3)) + dream_dataUrl.replacingOccurrences(of: "manager", with: "rr")))
        }
    }
}

...
fileprivate let mainCornerData:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_livetc_warn" :*/
fileprivate let mainBagSumTitle:String = "icon_lgift content size"
fileprivate let userListContent:[Character] = ["_","w","a","r","n"]

/*: "OK" :*/
fileprivate let mTabData:String = "Otip"
...
class DigitizerView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mainCornerData.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.namedImageNameBundle(name: (String(mainBagSumTitle.prefix(6)) + "ivetc" + String(userListContent)))
    ...
    private lazy var contentLab: UILabel = {
        ...
        lab.textAlignment = .center
        //: lab.text = ModeStageReactiveCompatible.share.appUserConfigMode.blockCameraPopupContent
        lab.text = ModeStageReactiveCompatible.share.appUserConfigMode.blockCameraPopupContent
        //: lab.numberOfLines = 0
        lab.numberOfLines = 0
        //: return lab
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(snapButtonPreEmption), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension DigitizerView {
    ...
    @objc private func snapButtonPreEmption() {
        //: dismiss()
        dataHead()
    }
}
...
extension DigitizerView {
    ...
    private func swordplaySubviews() {

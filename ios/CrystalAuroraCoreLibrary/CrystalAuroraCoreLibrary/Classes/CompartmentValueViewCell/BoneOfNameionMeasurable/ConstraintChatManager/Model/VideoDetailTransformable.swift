...
// __CLOSE_PRINT__
//
//  VideoDetailTransformable.swift
//
...
let kViewTitle = actualWidth(w: 275)
//: let VideoMsgTableViewHeight =  actualWidth(w: 200)
let k_keyName = actualWidth(w: 200)
//: let VideocellLineSpeing = 3
let kNameText = 3 /// cell间距

//: struct TalkingVideoCallDanmuModel: HandyJSON {
struct VideoDetailTransformable: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var senderUid = ""
    var senderUid = ""

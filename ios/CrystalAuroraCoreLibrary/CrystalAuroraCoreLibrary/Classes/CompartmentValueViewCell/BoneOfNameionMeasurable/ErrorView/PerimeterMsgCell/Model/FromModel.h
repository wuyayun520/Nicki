...
@property (nonatomic, strong) RestrictionModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) VendorColorModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) ViewModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) AmbitionModel *wantGift; /// 想要礼物
...
@interface RestrictionModel : JSONModel
...
@interface VendorColorModel: JSONModel
...
@interface StreamColorModel : JSONModel
...
@interface ShowTempModel : JSONModel
...
@interface AmbitionModel : JSONModel
...
@property (nonatomic, strong) PortraitModel *renderData;
...
@interface PortraitModel : JSONModel

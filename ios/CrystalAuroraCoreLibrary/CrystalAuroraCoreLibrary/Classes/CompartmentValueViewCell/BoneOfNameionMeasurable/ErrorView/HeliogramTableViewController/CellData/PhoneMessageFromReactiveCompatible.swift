...
/******************************************************************************
 *
 *  本文件声明了 PhoneMessageFromReactiveCompatible 类。
...
@objc public enum DetailTotalUnsignedMagnitude: UInt {
...
@objc public enum PratfallTermConvertible: UInt {
...
// MARK: - PhoneMessageFromReactiveCompatible

/**
 * 【模块名称】PhoneMessageFromReactiveCompatible
 ...
 */
//: @objcMembers public class PhoneMessageFromReactiveCompatible: TCommonCellData {
@objcMembers public class PhoneMessageFromReactiveCompatible: SameCellData {
    ...
    public var direction: PratfallTermConvertible = .MsgDirectionIncoming
    ...
    public var translateStatus: DetailTotalUnsignedMagnitude = .MsgTranslate_init
    ...
    public var msgModel: FromModel = FromModel()
    ...
    public var cellLayout: PlaceCellLayout!
    ...
    public init(direction: PratfallTermConvertible) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.betise()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = PlaceCellLayout(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = PlaceCellLayout(isIncomming: false)
    ...
    public override func style(_ width: CGFloat) -> CGFloat {

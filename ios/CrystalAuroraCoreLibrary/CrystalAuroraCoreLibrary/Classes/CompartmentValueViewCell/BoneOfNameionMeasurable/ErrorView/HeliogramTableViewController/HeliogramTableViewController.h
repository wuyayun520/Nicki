 ...
 *
 *  WorkerDelegate 协议和 HeliogramTableViewController 类。
 *  HeliogramTableViewController 是聊天界面的核心类，负责聊天界面大部分核心业务逻辑的处理与运算。
 *  该类的详细属性与功能，请参展本文件中 HeliogramTableViewController 的具体声明。
 *
 ******************************************************************************/
...
@class HeliogramTableViewController;
//: @class TitleViewCell;
@class TitleViewCell;
//: @class PhoneMessageFromReactiveCompatible;
@class PhoneMessageFromReactiveCompatible;
//: @class V2TIMMessage;
@class V2TIMMessage;
...
- (void)locked:(HeliogramTableViewController *)controller;
...
- (void)applicationing:(HeliogramTableViewController *)controller;
...
- (BOOL)deviceCell:(HeliogramTableViewController *)controller view:(UIView *)view;
 ...
 */
//: - (PhoneMessageFromReactiveCompatible *)messageController:(TUIMessageController *)controller onNewMessage:(V2TIMMessage *)data;
- (PhoneMessageFromReactiveCompatible *)burn:(HeliogramTableViewController *)controller fromMessage:(V2TIMMessage *)data;
 ...
 */
//: - (TitleViewCell *)messageController:(TUIMessageController *)controller onShowMessageData:(PhoneMessageFromReactiveCompatible *)data;
- (TitleViewCell *)withVisible:(HeliogramTableViewController *)controller can:(PhoneMessageFromReactiveCompatible *)data;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageAvatar:(TitleViewCell *)cell;
- (void)searchAlongAvatarMessageController:(HeliogramTableViewController *)controller modelData:(TitleViewCell *)cell;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageContent:(TitleViewCell *)cell;
- (void)windExposure:(HeliogramTableViewController *)controller of:(TitleViewCell *)cell;
 ...
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageMenu:(NSInteger)menuType withData:(PhoneMessageFromReactiveCompatible *)data;
- (void)fromNo:(HeliogramTableViewController *)controller doing:(NSInteger)menuType doProperty:(PhoneMessageFromReactiveCompatible *)data;
/**
...
/*重发*/
//: - (void)messageController:(TUIMessageController *)controller onRetryMessageContent:(TitleViewCell *)cell;
- (void)detect:(HeliogramTableViewController *)controller alongText:(TitleViewCell *)cell;

/*引用*/
//: - (void)messageController:(TUIMessageController *)controller onReplyMessage:(PhoneMessageFromReactiveCompatible *)cellData;
- (void)table:(HeliogramTableViewController *)controller session:(PhoneMessageFromReactiveCompatible *)cellData;

/*点击引用*/

//: - (void)messageController:(TUIMessageController *)controller onClickReplyMessage:(PhoneMessageFromReactiveCompatible *)cellData;
- (void)custom:(HeliogramTableViewController *)controller with:(PhoneMessageFromReactiveCompatible *)cellData;
...
/////////////////////////////////////////////////////////////////////////////////
//
//                         HeliogramTableViewController
//
/////////////////////////////////////////////////////////////////////////////////

/**
 * 腾讯云 TUIKit
 *  【模块名称】HeliogramTableViewController
...
@interface HeliogramTableViewController : UITableViewController

/**
 *  执行 WorkerDelegate 协议的委托
 */
 ...
 * @param uiMsgs 待删除的数据
 */
//- (void)deleteMessages:(NSArray<PhoneMessageFromReactiveCompatible *> *)uiMsgs;
...
/**
 * 批量将V2TIMessage转换成PhoneMessageFromReactiveCompatible
 */

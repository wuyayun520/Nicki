...
@objcMembers public class SameCellData: NSObject {
    //: public var reuseId: String?
    public var reuseId: String?
    
    //: public func heightOfWidth(_ width: CGFloat) -> CGFloat {
    public func style(_ width: CGFloat) -> CGFloat {
        //: return 44
        return 44
    }
}
...
@objcMembers public class PublicViewCell: UITableViewCell {
    
    //: private(set) public var data: TCommonCellData?
    private(set) public var data: SameCellData?
    ...
    @objc dynamic public func modify(with data: SameCellData) {
        //: self.data = data
        self.data = data
    }
} 
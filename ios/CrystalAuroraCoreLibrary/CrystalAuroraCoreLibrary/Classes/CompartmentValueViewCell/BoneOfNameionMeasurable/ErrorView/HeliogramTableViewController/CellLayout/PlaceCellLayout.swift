...
@objcMembers public class PlaceCellLayout: NSObject {
    ...
    class func searchApp() -> PlaceCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = PlaceCellLayout.init(isIncomming: true)
        //: return layout
        return layout
    }
    ...
    class func messageSize() -> PlaceCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = PlaceCellLayout.init(isIncomming: false)
        //: return layout
        return layout
    }
    ...
    class func cardWith() -> PlaceCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = PlaceCellLayout.init(isIncomming: false)
    ...
    class func displayWindow() -> PlaceCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = PlaceCellLayout.init(isIncomming: true)
        //: return layout
        return layout
    ...
    class func result() -> PlaceCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = PlaceCellLayout.init(isIncomming: false)
        //: return layout
        return layout

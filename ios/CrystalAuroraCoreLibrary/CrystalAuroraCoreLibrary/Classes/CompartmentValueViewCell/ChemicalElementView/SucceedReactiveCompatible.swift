...
fileprivate let kErrorTopMessage:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "UITableViewCellContentView" :*/
fileprivate let kQuantityTitle:[Character] = ["U","I","T","a","b","l","e","V","i","e","w","C","e","l","l"]
fileprivate let mOfMessage:String = "at systemCont"
fileprivate let main_cellKey:String = "entViewrecord let push cell bottom"
...
class SucceedReactiveCompatible: UIView {
    ...
    override init(frame: CGRect) {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(statusMode))
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kErrorTopMessage.reversed(), encoding: .utf8)!)
    }
    ...
    func bindMedium() {
        ...
        self.startScreen()?.view.endEditing(true)
...
extension SucceedReactiveCompatible: UIGestureRecognizerDelegate {
    ...
    func gestureRecognizer(_: UIGestureRecognizer, shouldReceive touch: UITouch) -> Bool {
        ...
        if classStr == (String(kQuantityTitle) + String(mOfMessage.suffix(4)) + String(main_cellKey.prefix(7))) {
            //: return false
            return false
            //: }else {
        } else {

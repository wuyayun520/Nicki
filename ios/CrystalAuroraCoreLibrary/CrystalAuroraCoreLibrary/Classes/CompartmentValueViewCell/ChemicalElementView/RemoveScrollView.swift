...
open class RemoveScrollView: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = RemoveScrollView.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {

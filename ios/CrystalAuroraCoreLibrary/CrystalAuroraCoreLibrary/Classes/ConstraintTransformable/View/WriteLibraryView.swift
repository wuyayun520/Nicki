...
fileprivate let showNumberMessage:[UInt8] = [0x65,0x62,0x65,0x78,0x24,0x6f,0x63,0x68,0x69,0x7e,0x36,0x25,0x2c,0x64,0x6d,0x7f,0x2c,0x62,0x63,0x78,0x2c,0x6e,0x69,0x69,0x62,0x2c,0x65,0x61,0x7c,0x60,0x69,0x61,0x69,0x62,0x78,0x69,0x68]

private func falseImage(take num: UInt8) -> UInt8 {
    return num ^ 12
}

/*: "icon_chat_start" :*/
fileprivate let k_coverId:String = "ICON"
fileprivate let m_pathIdent:[Character] = ["s","t","a","r","t"]

/*: "#752FE9" :*/
fileprivate let main_alwaysFormat:String = "super app#752FE9"

/*: "#F5F5F5" :*/
fileprivate let app_sharedFormat:[Character] = ["#","F","5","F","5","F","5"]

/*: "@ :*/
fileprivate let k_barName:[Character] = ["@"]

/*: "btn_feed_dianzan_nor" :*/
fileprivate let app_norIdent:[UInt8] = [0xcd,0xdf,0xd9,0xca,0xd1,0xd0,0xd0,0xcf,0xca,0xcf,0xd4,0xcc,0xd9,0xe5,0xcc,0xd9,0xca,0xd9,0xda,0xdd]

fileprivate func appealInside(center num: UInt8) -> UInt8 {
...
/*: "btn_feed_reply_nor" :*/
fileprivate let dreamMePath:String = "menu super selfbtn_"
fileprivate let dreamModelPlayLetValue:String = "label in allowly_nor"
...
class WriteLibraryView: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: showNumberMessage.map{falseImage(take: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var playView: UIImageView = {
        ...
        img.image = UIImage.namedImageNameBundle(name: (k_coverId.lowercased() + "_chat_" + String(m_pathIdent)))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    private lazy var atNickNameLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(main_alwaysFormat.suffix(7))))
    ...
    private lazy var mainContentView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(app_sharedFormat)))
...
extension WriteLibraryView {
    /// 刷新cell
    //: func refreshCell(_ model: TalkingRemindListModel) {
    func toNumber(_ model: TextModelType) {
        //: headImgView.setUrlImage(urlStr: model.headPic, placeImg: UIImage.placeSquareBigImgBanner())
        headImgView.giveAndTake(urlStr: model.headPic, placeImg: UIImage.aboveSend())
        ...
        previewImgView.placeOf(urlStr: model.imageUrl)
        ...
        let typeImgStr = (model.type == 0) ? String(bytes: app_norIdent.map{appealInside(center: $0)}, encoding: .utf8)! : (String(dreamMePath.suffix(4)) + "feed_rep" + String(dreamModelPlayLetValue.suffix(6)))
        //: statusIcon.image = UIImage.BundleImageNamed(name: typeImgStr)
        statusIcon.image = UIImage.namedImageNameBundle(name: typeImgStr)
...
extension WriteLibraryView {
    ...
    private func intervaleraction() {
        ...
        nickNameLab.snp.makeConstraints { make in
            ...
            make.width.lessThanOrEqualTo((kBlockRateValue - 128) / 2)
        }
